defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "with vaild data inserts user" do
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns unathorized error with invalid password", %{user: user} do
      assert {:error, :unauthorized} =
               Accounts.authenticate_by_username_and_pass(user.username, "badpadd")
    end
